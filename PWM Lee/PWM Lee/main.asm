...
setup:
	...
	ldi r16, 0b00_0000		
	out DDRC, r16			//Configura el puertoC de entradas
	...
	out TCCR0A, r16
	ldi r16, 0b011			//clk /64 (from prescaler) (dividimos el valor entre 64) //PONER 011 para trabajar a 1Khz aproximadamente
	out TCCR0B, r16
